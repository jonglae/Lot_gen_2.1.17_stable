...
import gotopark.buster.lottogen.Module.BackPressCloseHandler;
...
//                    text2.setTextSize (TypedValue.COMPLEX_UNIT_SP, 24);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //========================================================================
        View textView1 = (View)findViewById(R.id.textball_layout);
        View textView2 = (View)findViewById(R.id.layout_resultwin);
        View ImageView = (View)findViewById(R.id.lottoballs);
        ...
        Balltxt1 = (TextView) findViewById (R.id.balltext1);
        Balltxt2 = (TextView) findViewById (R.id.balltext2);
        Balltxt3 = (TextView) findViewById (R.id.balltext3);
        Balltxt4 = (TextView) findViewById (R.id.balltext4);
        Balltxt5 = (TextView) findViewById (R.id.balltext5);
        Balltxt6 = (TextView) findViewById (R.id.balltext6);



        Rtext1 = (TextView) findViewById (R.id.Rtext1);
        Rtext2 = (TextView) findViewById (R.id.Rtext2);
        Rtext3 = (TextView) findViewById (R.id.Rtext3);
        Rtext4 = (TextView) findViewById (R.id.Rtext4);
        Rtext5 = (TextView) findViewById (R.id.Rtext5);
        Rtext6 = (TextView) findViewById (R.id.Rtext6);
        Rtext7 = (TextView) findViewById (R.id.Rtext7);
        Rtext8 = (TextView) findViewById (R.id.Rtext8);
        ...
        Ballimg1 = (ImageView) findViewById (R.id.ballimage1);
        Ballimg2 = (ImageView) findViewById (R.id.ballimage2);
        Ballimg3 = (ImageView) findViewById (R.id.ballimage3);
        Ballimg4 = (ImageView) findViewById (R.id.ballimage4);
        Ballimg5 = (ImageView) findViewById (R.id.ballimage5);
        Ballimg6 = (ImageView) findViewById (R.id.ballimage6);


        //========================================================================

        RBall1 = (ImageView) findViewById (R.id.RBall1);
        RBall2 = (ImageView) findViewById (R.id.RBall2);
        RBall3 = (ImageView) findViewById (R.id.RBall3);
        RBall4 = (ImageView) findViewById (R.id.RBall4);
        RBall5 = (ImageView) findViewById (R.id.RBall5);
        RBall6 = (ImageView) findViewById (R.id.RBall6);
        RBall7 = (ImageView) findViewById (R.id.RBall7);
        RBall8 = (ImageView) findViewById (R.id.RBall8);

        //========================================================================

        Rtilte = (TextView) findViewById (R.id.Rtitle);
        Resultwin1 = (TextView) findViewById (R.id.winText1);
        Resultwin2 = (TextView) findViewById (R.id.winText2);
        Resultwin3 = (TextView) findViewById (R.id.winText3);
        Resultwin4 = (TextView) findViewById (R.id.winText4);
        Resultwin5 = (TextView) findViewById (R.id.winText5);
        /*
         *
         * 시작시 메세지 출력
         *
...
//https 설정 ssl hanshare fail 적용 위한 code --> End
            ...
            try {
                ...
                if (document != null) {
                    ...
                    F10 = document.select ("#latest_draw");
                    F11 = document.select ("#latest_date");
                    F12 = document.select ("#latest_numbers .ball");
                    F13 = document.select ("#latest_divisions .divisions");
                    F14 = document.select (".upcoming .info");
